...
members_name='../data/2017/Membership/2017-01-03 Members Hudson Mohawk Road Runners Club.csv'
race_name='../data/2017/1_HH/17Hangover_half.csv'

race_out_base='../data/2017/1_HH/Hangover_'
